 ...
 <h2 >Orders by Buy</h2>
    <table border="1">
        ...
        <tr>
            ...
            <td><a href="cinf.php?sid=<?php echo htmlspecialchars($order['uid']); ?>">View</a></td>
        </tr>
        <?php endforeach; ?>
    </table>
</div>
...
<div id="Orders2" class="tabcontent" style="margin-top:90px;">
    ...
    <table border="1">
        ...
        <?php while ($quickOrder = $quickOrdersResult->fetch_assoc()): ?>
        <tr>
            ...
            <td><a href="cinf.php?sid=<?php echo htmlspecialchars($quickOrder['cid']); ?>">View</a></td>
        </tr>
        <?php endwhile; ?>
    </table>
</div>
